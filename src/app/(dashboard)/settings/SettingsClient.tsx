// src/app/settings/SettingsClient.tsx (PART 1 - GLOBAL LAYOUT & CONTENT SAFETY)
"use client";
  ...
  return (
    <div className={`min-h-screen font-sans antialiased transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
        ...
        {/* LEFT COLUMN: App Sidebar Navigation Menu Layout */}
        ...
        <main className={`col-span-1 lg:col-span-9 border transition-colors duration-300 rounded-3xl p-6 sm:p-10 shadow-sm text-left space-y-8 ${
          ...
          <section className="space-y-4 border-t border-gray-100 dark:border-gray-800 pt-6">
            ...
            <div className={`p-4 rounded-2xl flex items-center justify-between border ${
              ...
              <div>
                ...
                <span className="text-[10px] font-bold text-gray-400 block">Switch between light (default) and dark themes across Dollspace.</span>
              </div>
              <button
                type="button"
          ...
          <section className="space-y-4 border-t border-gray-100 dark:border-gray-800 pt-6">
            ...
            <p className="text-[11px] text-gray-400 font-semibold mt-1">
              Select which real-time event updates dispatch email logs directly to your personal mailbox (Default: Off).
            </p>
          ...
          {/* SECTION 5: ACCOUNT LIFECYCLE DANGER ZONE */}
          <section className="space-y-4 border-t border-gray-100 dark:border-gray-800 pt-6">
          ...
          {/* GLOBAL SAVE CONFIGURATION PREFERENCES BUTTON */}
          <div className="border-t border-gray-100 dark:border-gray-800 pt-6 flex justify-end">
            <button type="button" onClick={() => alert("Saved live onto the system cluster.")} className="bg-rose-500 hover:bg-rose-600 text-white font-black text-xs uppercase tracking-widest px-8 py-3.5 rounded-xl transition shadow-md hover:shadow-lg cursor-pointer transform hover:-translate-y-[1px] active:translate-y-0">Save Configuration Settings ✨</button>
          </div>
        </main>
      </div>
    </div>
