...
export default function ProfileClient({ 
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      {/* DYNAMIC DISPLAY ROUTER VIEWPORT PORTALS */}
      {activeTab === "ALBUMS" ? (
        ...
        <>
          ...
          <div className="space-y-4 mt-2">
            {taggedPosts.length === 0 ? (
              <div className="bg-white border border-dashed border-gray-200 p-12 rounded-2xl text-center text-gray-400 shadow-sm"><span className="text-2xl block mb-1">🏷️</span><p className="font-bold text-xs uppercase tracking-wider">No tag citations yet</p></div>
            ) : (
