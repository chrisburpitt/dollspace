      ...
      <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
        ...
        <main className="lg:col-span-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-0.5">
                      ...
                      {calculatedAgeValue !== null && (
                        <span className="text-gray-900 font-medium text-xs bg-rose-100 px-2 py-0.5 rounded-md">
          ...
          <div className="flex bg-white border border-gray-200 p-1 rounded-xl shadow-sm font-black text-xs uppercase tracking-wide">
            <button onClick={() => setActiveTab("FEED")} className={`flex-1 py-2.5 rounded-lg transition text-center ${activeTab === "FEED" ? "bg-rose-500 text-white shadow-sm" : "text-gray-400 hover:text-gray-600"}`}>{user.displayName}'s Posts ({userPosts.length})</button>
